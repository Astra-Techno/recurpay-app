        ...
        <div class="px-0 pb-1.5 border-[#e0e6ed] dark:border-[#1b2e4b]">
            ...
            <FormKit type="form" #default="{ value }" submit-label="Send Request">
				<div  class="">
					...
					<AutoComplete prefix-icon="search" v-model="item.job.job_property" select-icon="" label="Property address" debounce="500" min="3" placeholder="Search Property..." limit="10" validation="required"
					...
					<PropertyContacts :property-id="item.job.job_property" />
				</div>
            </FormKit>
...
<script lang="ts" setup>
    ...
    import PropertyContacts from '@/components/Property/Contacts.vue'
