...
export default {
  init() {
    ...
    val = localStorage.getItem("background")
    store.background =val || $themeConfig.background;
    ...
    val = localStorage.getItem("fullview")
    val = val || $themeConfig.fullview
    store.toggleFullView(val)
